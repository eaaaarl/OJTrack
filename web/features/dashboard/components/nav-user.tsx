...
import { useGetUserQuery, useSignOutMutation } from "@/features/auth/api/authApi"
          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <div className="grid flex-1 text-left text-sm leading-tight">
                <span className="truncate font-medium">{profile?.profile.name}</span>
                <span className="truncate text-xs">{profile?.profile.email}</span>
              </div>
